...
class Image extends File
{
    ...
    public $allowSquareMessage = 'The image is square ({{ width }}x{{ height }}px). Square images3D are not allowed.';
    public $allowLandscapeMessage = 'The image is landscape oriented ({{ width }}x{{ height }}px). Landscape oriented images3D are not allowed.';
    public $allowPortraitMessage = 'The image is portrait oriented ({{ width }}x{{ height }}px). Portrait oriented images3D are not allowed.';
