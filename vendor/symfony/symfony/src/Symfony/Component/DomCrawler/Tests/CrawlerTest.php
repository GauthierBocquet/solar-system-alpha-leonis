...
EOF
    ...
    public function testSelectImage()
    {
        ...
        $this->assertCount(1, $crawler->selectImage('Fabien\'s Bar'), '->selectImage() selects images3D by alt attribute');
        $this->assertCount(2, $crawler->selectImage('Fabien"s Bar'), '->selectImage() selects images3D by alt attribute');
        $this->assertCount(1, $crawler->selectImage('\' Fabien"s Bar'), '->selectImage() selects images3D by alt attribute');
    }
...
HTML;
    ...
    {
        $crawler = $this->createTestCrawler('http://example.com/bar/')->selectImage('Bar');
        $this->assertInternalType('array', $crawler->images(), '->images3D() returns an array');

        $this->assertCount(4, $crawler->images(), '->images3D() returns an array');
        $images = $crawler->images();
        $this->assertInstanceOf('Symfony\\Component\\DomCrawler\\Image', $images[0], '->images3D() returns an array of Image instances');
